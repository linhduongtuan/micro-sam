...
if ds is None:
    ...
    if ds == "covid_if":
        ...
        train_loader = torchem_data.get_covid_if_loader(download_folder, #sample_range=train_range, 
                                                        **kwargs)
        val_loader = torchem_data.get_covid_if_loader(download_folder, #sample_range=val_range, 
                                                      **kwargs)
